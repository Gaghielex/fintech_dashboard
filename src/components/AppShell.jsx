  ...
  return (
    <div className="flex min-h-dvh min-w-0 overflow-x-hidden bg-canvas">
      <div
        ...
        style={{
          height: 'calc(env(safe-area-inset-top, 0px) + 2rem)',
          background:
            'linear-gradient(to bottom, rgba(13, 17, 23, 0.84) 0%, rgba(13, 17, 23, 0.52) 48%, rgba(13, 17, 23, 0) 100%)',
          backdropFilter: 'blur(18px) saturate(1.35)',
          WebkitBackdropFilter: 'blur(18px) saturate(1.35)',
          maskImage: 'linear-gradient(to bottom, black 0%, rgba(0,0,0,0.7) 58%, transparent 100%)',
          WebkitMaskImage: 'linear-gradient(to bottom, black 0%, rgba(0,0,0,0.7) 58%, transparent 100%)',
        }}
        aria-hidden
      />
      <SideNav />
