...
function IconAccounts({ active }) {
  const c = active ? 'var(--palette-primary)' : 'var(--palette-text-tertiary)'
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" style={{ color: c }} aria-hidden>
...
function IconGoals({ active }) {
  const c = active ? 'var(--palette-primary)' : 'var(--palette-text-tertiary)'
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 48 48" style={{ color: c }} aria-hidden>
      <g fill="none">
